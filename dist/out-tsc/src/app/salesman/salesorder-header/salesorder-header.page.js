...
var SalesorderHeaderPage = /** @class */ (function () {
    function SalesorderHeaderPage() {
    }
    SalesorderHeaderPage.prototype.ngOnInit = function () {
    ...
    SalesorderHeaderPage = __decorate([
        Component({
    ...
    return SalesorderHeaderPage;
}());
export { SalesorderHeaderPage };
//# sourceMappingURL=salesorder-header.page.js.map