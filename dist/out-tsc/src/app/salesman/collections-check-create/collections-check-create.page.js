...
var CollectionsCheckCreatePage = /** @class */ (function () {
    function CollectionsCheckCreatePage(modalController, events) {
        var _this = this;
    ...
    CollectionsCheckCreatePage.prototype.ngOnInit = function () {
    };
    CollectionsCheckCreatePage.prototype.presentModal = function (item) {
    ...
    CollectionsCheckCreatePage.prototype.deleteCheque = function (array, index) {
        console.log(array);
        if (index > -1) {
    ...
    CollectionsCheckCreatePage.prototype.updateModal = function (item, data, index) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    CollectionsCheckCreatePage = __decorate([
        Component({
        ...
        __metadata("design:paramtypes", [ModalController,
            Events])
    ], CollectionsCheckCreatePage);
    return CollectionsCheckCreatePage;
}());
export { CollectionsCheckCreatePage };
//# sourceMappingURL=collections-check-create.page.js.map